...
public:
    ...
    void handle_status_cb(lv_event_t *event);
    ...
    static void _handle_status_cb(lv_event_t *event) {
        MainPanel *panel = (MainPanel *) event->user_data;
        panel->handle_status_cb(event);
    };
