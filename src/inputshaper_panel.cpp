...
InputShaperPanel::InputShaperPanel(KWebSocketClient &c, std::mutex &l)
    ...
    static lv_coord_t grid_main_row_dsc[] = {
        LV_GRID_FR(2), LV_GRID_FR(1), LV_GRID_FR(1),
        LV_GRID_TEMPLATE_LAST
    };
    static lv_coord_t grid_main_col_dsc[] = {
        LV_GRID_FR(3), LV_GRID_FR(7), LV_GRID_FR(7),
        LV_GRID_TEMPLATE_LAST
    };
